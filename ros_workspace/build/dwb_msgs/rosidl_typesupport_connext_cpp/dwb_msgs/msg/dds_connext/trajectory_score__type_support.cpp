...
#include "dwb_msgs/msg/trajectory_score__rosidl_typesupport_connext_cpp.hpp"
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !dwb_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ...
          dds_message.scores_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  dwb_msgs::msg::TrajectoryScore & ros_message)
{
  ...
  // member.name scores
  {
    size_t size = dds_message.scores_.length();
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const dwb_msgs::msg::TrajectoryScore & ros_message =
    *(const dwb_msgs::msg::TrajectoryScore *)untyped_ros_message;

  // create a respective connext dds type
  dwb_msgs::msg::dds_::TrajectoryScore_ * dds_message = dwb_msgs::msg::dds_::TrajectoryScore_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs::msg::TrajectoryScore & ros_message =
    *(dwb_msgs::msg::TrajectoryScore *)untyped_ros_message;
...
{
  return &dwb_msgs::msg::typesupport_connext_cpp::_TrajectoryScore__handle;
}
