...
DDS_TypeCode *
get_type_code__GenerateTwists_Request()
{
...
bool
to_cdr_stream__GenerateTwists_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const dwb_msgs::srv::GenerateTwists_Request & ros_message =
    *(const dwb_msgs::srv::GenerateTwists_Request *)untyped_ros_message;

  // create a respective connext dds type
  dwb_msgs::srv::dds_::GenerateTwists_Request_ * dds_message = dwb_msgs::srv::dds_::GenerateTwists_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__GenerateTwists_Request(
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs::srv::GenerateTwists_Request & ros_message =
    *(dwb_msgs::srv::GenerateTwists_Request *)untyped_ros_message;
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GenerateTwists_Request__handle;
}
...
DDS_TypeCode *
get_type_code__GenerateTwists_Response()
{
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !nav_2d_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ...
          dds_message.twists_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  dwb_msgs::srv::GenerateTwists_Response & ros_message)
{
  // member.name twists
  {
    size_t size = dds_message.twists_.length();
...
bool
to_cdr_stream__GenerateTwists_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const dwb_msgs::srv::GenerateTwists_Response & ros_message =
    *(const dwb_msgs::srv::GenerateTwists_Response *)untyped_ros_message;

  // create a respective connext dds type
  dwb_msgs::srv::dds_::GenerateTwists_Response_ * dds_message = dwb_msgs::srv::dds_::GenerateTwists_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__GenerateTwists_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  dwb_msgs::srv::GenerateTwists_Response & ros_message =
    *(dwb_msgs::srv::GenerateTwists_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (dwb_msgs::srv::dds_::GenerateTwists_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GenerateTwists_Response__handle;
}
...
void * create_requester__GenerateTwists(
...
const char * destroy_requester__GenerateTwists(
...
int64_t send_request__GenerateTwists(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = dwb_msgs::srv::GenerateTwists_Request;
  using RequesterType = connext::Requester<
    dwb_msgs::srv::dds_::GenerateTwists_Request_,
    dwb_msgs::srv::dds_::GenerateTwists_Response_
  >;
  connext::WriteSample<
    dwb_msgs::srv::dds_::GenerateTwists_Request_> request;
...
void * create_replier__GenerateTwists(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__GenerateTwists(
...
bool take_request__GenerateTwists(
  void * untyped_replier,
...
bool take_response__GenerateTwists(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    dwb_msgs::srv::dds_::GenerateTwists_Response_
  >;
  using ROSResponseType = dwb_msgs::srv::GenerateTwists_Response;
...
{
  using ROSResponseType = const dwb_msgs::srv::GenerateTwists_Response;
  using ReplierType = connext::Replier<
    dwb_msgs::srv::dds_::GenerateTwists_Request_,
    dwb_msgs::srv::dds_::GenerateTwists_Response_
  >;
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GenerateTwists__handle;
}
