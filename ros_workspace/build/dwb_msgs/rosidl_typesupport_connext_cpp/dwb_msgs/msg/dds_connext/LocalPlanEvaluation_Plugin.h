...
#ifndef LocalPlanEvaluation_Plugin_977663518_h
#define LocalPlanEvaluation_Plugin_977663518_h
...
namespace dwb_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define LocalPlanEvaluation_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define LocalPlanEvaluation_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define LocalPlanEvaluation_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define LocalPlanEvaluation_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define LocalPlanEvaluation_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern LocalPlanEvaluation_*
            ...
            LocalPlanEvaluation_PluginSupport_copy_data(
                LocalPlanEvaluation_ *out,
                const LocalPlanEvaluation_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            LocalPlanEvaluation_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            LocalPlanEvaluation_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                LocalPlanEvaluation_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            LocalPlanEvaluation_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                LocalPlanEvaluation_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            LocalPlanEvaluation_Plugin_new(void);

            NDDSUSERDllExport extern void
            LocalPlanEvaluation_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* LocalPlanEvaluation_Plugin_977663518_h */
