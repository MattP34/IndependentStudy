...
#include "dwb_msgs/srv/score_trajectory__rosidl_typesupport_connext_c.h"
...
#include "dwb_msgs/srv/score_trajectory__rosidl_typesupport_connext_cpp.hpp"
...
static DDS_TypeCode *
_ScoreTrajectory_Request__get_type_code()
{
  return dwb_msgs::srv::dds_::ScoreTrajectory_Request_TypeSupport::get_typecode();
}

static bool
_ScoreTrajectory_Request__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const dwb_msgs__srv__ScoreTrajectory_Request * ros_message =
    static_cast<const dwb_msgs__srv__ScoreTrajectory_Request *>(untyped_ros_message);
  dwb_msgs::srv::dds_::ScoreTrajectory_Request_ * dds_message =
    static_cast<dwb_msgs::srv::dds_::ScoreTrajectory_Request_ *>(untyped_dds_message);
  // Member name: pose
  {
...
static bool
_ScoreTrajectory_Request__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const dwb_msgs::srv::dds_::ScoreTrajectory_Request_ * dds_message =
    static_cast<const dwb_msgs::srv::dds_::ScoreTrajectory_Request_ *>(untyped_dds_message);
  dwb_msgs__srv__ScoreTrajectory_Request * ros_message =
    static_cast<dwb_msgs__srv__ScoreTrajectory_Request *>(untyped_ros_message);
  // Member name: pose
  {
...
static bool
_ScoreTrajectory_Request__to_cdr_stream(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const dwb_msgs__srv__ScoreTrajectory_Request * ros_message =
    static_cast<const dwb_msgs__srv__ScoreTrajectory_Request *>(untyped_ros_message);
  dwb_msgs::srv::dds_::ScoreTrajectory_Request_ dds_message;
  if (!_ScoreTrajectory_Request__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }

  // call the serialize function for the first time to get the expected length of the message
  unsigned int expected_length;
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Request_Plugin_serialize_to_cdr_buffer(
      NULL, &expected_length, &dds_message) != RTI_TRUE)
  {
    fprintf(stderr, "failed to call dwb_msgs::srv::dds_::ScoreTrajectory_Request_Plugin_serialize_to_cdr_buffer()\n");
    return false;
  }
...
static bool
_ScoreTrajectory_Request__to_message(
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs::srv::dds_::ScoreTrajectory_Request_ * dds_message =
    dwb_msgs::srv::dds_::ScoreTrajectory_Request_TypeSupport::create_data();
  if (cdr_stream->buffer_length > (std::numeric_limits<unsigned int>::max)()) {
    fprintf(stderr, "cdr_stream->buffer_length, unexpectedly larger than max unsigned int\n");
    return false;
  }
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Request_Plugin_deserialize_from_cdr_buffer(
      dds_message,
      reinterpret_cast<char *>(cdr_stream->buffer),
  ...
  bool success = _ScoreTrajectory_Request__convert_dds_to_ros(dds_message, untyped_ros_message);
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Request_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
  return success;
}
...
static message_type_support_callbacks_t _ScoreTrajectory_Request__callbacks = {
  ...
  "ScoreTrajectory_Request",  // message_name
  _ScoreTrajectory_Request__get_type_code,  // get_type_code
  _ScoreTrajectory_Request__convert_ros_to_dds,  // convert_ros_to_dds
  _ScoreTrajectory_Request__convert_dds_to_ros,  // convert_dds_to_ros
  _ScoreTrajectory_Request__to_cdr_stream,  // to_cdr_stream
  _ScoreTrajectory_Request__to_message  // to_message
};
...
static DDS_TypeCode *
_ScoreTrajectory_Response__get_type_code()
{
  return dwb_msgs::srv::dds_::ScoreTrajectory_Response_TypeSupport::get_typecode();
}

static bool
_ScoreTrajectory_Response__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const dwb_msgs__srv__ScoreTrajectory_Response * ros_message =
    static_cast<const dwb_msgs__srv__ScoreTrajectory_Response *>(untyped_ros_message);
  dwb_msgs::srv::dds_::ScoreTrajectory_Response_ * dds_message =
    static_cast<dwb_msgs::srv::dds_::ScoreTrajectory_Response_ *>(untyped_dds_message);
  // Member name: score
  {
...
static bool
_ScoreTrajectory_Response__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const dwb_msgs::srv::dds_::ScoreTrajectory_Response_ * dds_message =
    static_cast<const dwb_msgs::srv::dds_::ScoreTrajectory_Response_ *>(untyped_dds_message);
  dwb_msgs__srv__ScoreTrajectory_Response * ros_message =
    static_cast<dwb_msgs__srv__ScoreTrajectory_Response *>(untyped_ros_message);
  // Member name: score
  {
    const rosidl_message_type_support_t * ts =
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
...
static bool
_ScoreTrajectory_Response__to_cdr_stream(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!untyped_ros_message) {
  ...
  const dwb_msgs__srv__ScoreTrajectory_Response * ros_message =
    static_cast<const dwb_msgs__srv__ScoreTrajectory_Response *>(untyped_ros_message);
  dwb_msgs::srv::dds_::ScoreTrajectory_Response_ dds_message;
  if (!_ScoreTrajectory_Response__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }

  // call the serialize function for the first time to get the expected length of the message
  unsigned int expected_length;
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Response_Plugin_serialize_to_cdr_buffer(
      NULL, &expected_length, &dds_message) != RTI_TRUE)
  {
    fprintf(stderr, "failed to call dwb_msgs::srv::dds_::ScoreTrajectory_Response_Plugin_serialize_to_cdr_buffer()\n");
    return false;
  }
  if (expected_length > (std::numeric_limits<unsigned int>::max)()) {
    fprintf(stderr, "expected_length, unexpectedly larger than max unsigned int\n");
...
static bool
_ScoreTrajectory_Response__to_message(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  dwb_msgs::srv::dds_::ScoreTrajectory_Response_ * dds_message =
    dwb_msgs::srv::dds_::ScoreTrajectory_Response_TypeSupport::create_data();
  if (cdr_stream->buffer_length > (std::numeric_limits<unsigned int>::max)()) {
    fprintf(stderr, "cdr_stream->buffer_length, unexpectedly larger than max unsigned int\n");
    return false;
  }
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Response_Plugin_deserialize_from_cdr_buffer(
      dds_message,
      reinterpret_cast<char *>(cdr_stream->buffer),
      static_cast<unsigned int>(cdr_stream->buffer_length)) != RTI_TRUE)
  {
  ...
  bool success = _ScoreTrajectory_Response__convert_dds_to_ros(dds_message, untyped_ros_message);
  if (dwb_msgs::srv::dds_::ScoreTrajectory_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
  return success;
}
...
static message_type_support_callbacks_t _ScoreTrajectory_Response__callbacks = {
  "dwb_msgs::srv",  // message_namespace
  "ScoreTrajectory_Response",  // message_name
  _ScoreTrajectory_Response__get_type_code,  // get_type_code
  _ScoreTrajectory_Response__convert_ros_to_dds,  // convert_ros_to_dds
  _ScoreTrajectory_Response__convert_dds_to_ros,  // convert_dds_to_ros
  _ScoreTrajectory_Response__to_cdr_stream,  // to_cdr_stream
  _ScoreTrajectory_Response__to_message  // to_message
};
...
static void * create_requester__ScoreTrajectory(
...
{
  return dwb_msgs::srv::typesupport_connext_cpp::create_requester__ScoreTrajectory(
    untyped_participant,
    request_topic_str,
    response_topic_str,
...
static const char * destroy_requester__ScoreTrajectory(
  void * untyped_requester,
  void (* deallocator)(void *))
{
  return dwb_msgs::srv::typesupport_connext_cpp::destroy_requester__ScoreTrajectory(
    untyped_requester, deallocator);
}

static int64_t send_request__ScoreTrajectory(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using RequesterType = connext::Requester<
    dwb_msgs::srv::dds_::ScoreTrajectory_Request_,
    dwb_msgs::srv::dds_::ScoreTrajectory_Response_
  >;
  connext::WriteSample<dwb_msgs::srv::dds_::ScoreTrajectory_Request_> request;
  const rosidl_message_type_support_t * ts =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_connext_c,
    dwb_msgs, srv,
...
static void * create_replier__ScoreTrajectory(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
  ...
  void * (*allocator)(size_t))
{
  return dwb_msgs::srv::typesupport_connext_cpp::create_replier__ScoreTrajectory(
    untyped_participant,
    request_topic_str,
    response_topic_str,
    untyped_datareader_qos,
...
static const char * destroy_replier__ScoreTrajectory(
  void * untyped_replier,
  void (* deallocator)(void *))
{
  return dwb_msgs::srv::typesupport_connext_cpp::destroy_replier__ScoreTrajectory(
    untyped_replier, deallocator);
}

static bool take_request__ScoreTrajectory(
  void * untyped_replier,
  ...
  void * untyped_ros_request)
{
  ...
  connext::Sample<dwb_msgs::srv::dds_::ScoreTrajectory_Request_> request;
...
static bool take_response__ScoreTrajectory(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  ...
  connext::Sample<dwb_msgs::srv::dds_::ScoreTrajectory_Response_> response;
...
bool send_response__ScoreTrajectory(
  void * untyped_replier,
  ...
  const void * untyped_ros_response)
{
  ...
  connext::WriteSample<dwb_msgs::srv::dds_::ScoreTrajectory_Response_> response;
  const rosidl_message_type_support_t * ts =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_connext_c,
    dwb_msgs, srv,
...
{
  return dwb_msgs::srv::typesupport_connext_cpp::get_request_datawriter__ScoreTrajectory(
    untyped_requester);
}
...
{
  return dwb_msgs::srv::typesupport_connext_cpp::get_reply_datareader__ScoreTrajectory(
    untyped_requester);
}
...
{
  return dwb_msgs::srv::typesupport_connext_cpp::get_request_datareader__ScoreTrajectory(
    untyped_replier);
}
...
{
  return dwb_msgs::srv::typesupport_connext_cpp::get_reply_datawriter__ScoreTrajectory(
    untyped_replier);
}
...
static service_type_support_callbacks_t _ScoreTrajectory__callbacks = {
  ...
  &get_request_datawriter__ScoreTrajectory,
  &get_reply_datareader__ScoreTrajectory,
  &get_request_datareader__ScoreTrajectory,
  &get_reply_datawriter__ScoreTrajectory
};

static rosidl_service_type_support_t _ScoreTrajectory__type_support = {
  rosidl_typesupport_connext_c__identifier,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(
  ...
  ScoreTrajectory)()
{
  return &_ScoreTrajectory__type_support;
}
