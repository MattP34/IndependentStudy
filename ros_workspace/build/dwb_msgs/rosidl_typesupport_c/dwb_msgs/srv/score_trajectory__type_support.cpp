...
static const _ScoreTrajectory_Request_type_support_symbol_names_t _ScoreTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, dwb_msgs, srv, ScoreTrajectory_Request)),
...
static const _ScoreTrajectory_Response_type_support_symbol_names_t _ScoreTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, dwb_msgs, srv, ScoreTrajectory_Response)),
...
static const _ScoreTrajectory_type_support_symbol_names_t _ScoreTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, dwb_msgs, srv, ScoreTrajectory)),
