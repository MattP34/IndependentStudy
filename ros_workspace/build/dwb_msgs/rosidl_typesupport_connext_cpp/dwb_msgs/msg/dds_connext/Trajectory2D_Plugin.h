...
#ifndef Trajectory2D_Plugin_507385092_h
#define Trajectory2D_Plugin_507385092_h
...
namespace dwb_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define Trajectory2D_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Trajectory2D_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Trajectory2D_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Trajectory2D_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Trajectory2D_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Trajectory2D_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Trajectory2D_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Trajectory2D_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            Trajectory2D_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Trajectory2D_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            Trajectory2D_Plugin_new(void);

            NDDSUSERDllExport extern void
            Trajectory2D_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Trajectory2D_Plugin_507385092_h */
