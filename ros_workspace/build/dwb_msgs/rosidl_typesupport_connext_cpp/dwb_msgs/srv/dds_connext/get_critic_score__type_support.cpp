  ...
  dwb_msgs::srv::dds_::GetCriticScore_Request_ & dds_message)
{
  ...
  DDS_String_free(dds_message.critic_name_);
  dds_message.critic_name_ =
    DDS_String_dup(ros_message.critic_name.c_str());
  ...
  dwb_msgs::srv::GetCriticScore_Request & ros_message)
{
  ...
  // member.name critic_name
  ros_message.critic_name = dds_message.critic_name_;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const dwb_msgs::srv::GetCriticScore_Request & ros_message =
    *(const dwb_msgs::srv::GetCriticScore_Request *)untyped_ros_message;

  // create a respective connext dds type
  dwb_msgs::srv::dds_::GetCriticScore_Request_ * dds_message = dwb_msgs::srv::dds_::GetCriticScore_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs::srv::GetCriticScore_Request & ros_message =
    *(dwb_msgs::srv::GetCriticScore_Request *)untyped_ros_message;
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GetCriticScore_Request__handle;
}
...
bool convert_ros_message_to_dds(
  ...
  dwb_msgs::msg::dds_::CriticScore_ &);
bool convert_dds_message_to_ros(
  const dwb_msgs::msg::dds_::CriticScore_ &,
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const dwb_msgs::srv::GetCriticScore_Response & ros_message =
    *(const dwb_msgs::srv::GetCriticScore_Response *)untyped_ros_message;

  // create a respective connext dds type
  dwb_msgs::srv::dds_::GetCriticScore_Response_ * dds_message = dwb_msgs::srv::dds_::GetCriticScore_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs::srv::GetCriticScore_Response & ros_message =
    *(dwb_msgs::srv::GetCriticScore_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (dwb_msgs::srv::dds_::GetCriticScore_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GetCriticScore_Response__handle;
}
...
void * create_requester__GetCriticScore(
...
const char * destroy_requester__GetCriticScore(
...
int64_t send_request__GetCriticScore(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = dwb_msgs::srv::GetCriticScore_Request;
  using RequesterType = connext::Requester<
    dwb_msgs::srv::dds_::GetCriticScore_Request_,
    dwb_msgs::srv::dds_::GetCriticScore_Response_
  >;
  connext::WriteSample<
    dwb_msgs::srv::dds_::GetCriticScore_Request_> request;
...
void * create_replier__GetCriticScore(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__GetCriticScore(
...
bool take_request__GetCriticScore(
  void * untyped_replier,
...
bool take_response__GetCriticScore(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    dwb_msgs::srv::dds_::GetCriticScore_Response_
  >;
  using ROSResponseType = dwb_msgs::srv::GetCriticScore_Response;
...
{
  using ROSResponseType = const dwb_msgs::srv::GetCriticScore_Response;
  using ReplierType = connext::Replier<
    dwb_msgs::srv::dds_::GetCriticScore_Request_,
    dwb_msgs::srv::dds_::GetCriticScore_Response_
  >;
...
{
  return &dwb_msgs::srv::typesupport_connext_cpp::_GetCriticScore__handle;
}
