...
#ifndef GenerateTrajectory_Plugin_2108612273_h
#define GenerateTrajectory_Plugin_2108612273_h
...
namespace dwb_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define GenerateTrajectory_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GenerateTrajectory_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GenerateTrajectory_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GenerateTrajectory_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GenerateTrajectory_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GenerateTrajectory_Request_*
            ...
            GenerateTrajectory_Request_PluginSupport_copy_data(
                GenerateTrajectory_Request_ *out,
                const GenerateTrajectory_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GenerateTrajectory_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GenerateTrajectory_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GenerateTrajectory_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GenerateTrajectory_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GenerateTrajectory_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            GenerateTrajectory_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            GenerateTrajectory_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace dwb_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define GenerateTrajectory_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GenerateTrajectory_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GenerateTrajectory_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GenerateTrajectory_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GenerateTrajectory_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GenerateTrajectory_Response_*
            ...
            GenerateTrajectory_Response_PluginSupport_copy_data(
                GenerateTrajectory_Response_ *out,
                const GenerateTrajectory_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GenerateTrajectory_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GenerateTrajectory_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GenerateTrajectory_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GenerateTrajectory_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GenerateTrajectory_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            GenerateTrajectory_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            GenerateTrajectory_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* GenerateTrajectory_Plugin_2108612273_h */
