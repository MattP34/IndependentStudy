...
#ifndef DebugLocalPlan_Plugin_795592973_h
#define DebugLocalPlan_Plugin_795592973_h
...
namespace dwb_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define DebugLocalPlan_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define DebugLocalPlan_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define DebugLocalPlan_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define DebugLocalPlan_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define DebugLocalPlan_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern DebugLocalPlan_Request_*
            ...
            DebugLocalPlan_Request_PluginSupport_copy_data(
                DebugLocalPlan_Request_ *out,
                const DebugLocalPlan_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            DebugLocalPlan_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            DebugLocalPlan_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                DebugLocalPlan_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            DebugLocalPlan_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DebugLocalPlan_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            DebugLocalPlan_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            DebugLocalPlan_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace dwb_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define DebugLocalPlan_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define DebugLocalPlan_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define DebugLocalPlan_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define DebugLocalPlan_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define DebugLocalPlan_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern DebugLocalPlan_Response_*
            ...
            DebugLocalPlan_Response_PluginSupport_copy_data(
                DebugLocalPlan_Response_ *out,
                const DebugLocalPlan_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            DebugLocalPlan_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            DebugLocalPlan_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                DebugLocalPlan_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            DebugLocalPlan_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                DebugLocalPlan_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            DebugLocalPlan_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            DebugLocalPlan_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* DebugLocalPlan_Plugin_795592973_h */
